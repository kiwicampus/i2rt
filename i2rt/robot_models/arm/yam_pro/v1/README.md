...
| --- | ---: | --- | --- |
| `base` | 0.873654 | `0 0 0.024768` | `π π/2 0` |
...
| --- | --- | --- | --- | --- | --- | --- | ---: |
| `joint1` | `base → link1` | `0 0 0.068` | `-π π/2 0` | `-1 0 0` | `[-5π/6, π]` | `[-150, 180]` | 0.0680000000 |
...
| `link2 / joint2` | `0.0200001671307 0.0329 0.113499926536` | `π π/2 0` | `0 1 0` |
| `link3 / joint3` | `-0.243999832868 0.0349499999999 0.113500896262` | `π π/2 0` | `0 -1 0` |
| `link4 / joint4` | `0.000999387524241 -0.03385 0.17350029633` | `π π/2 0` | `0 -1 0` |
| `link5 / joint5` | `0.074998435555 0 0.213800324516` | `π π/2 0` | `0 0 -1` |
| `gripper / joint6` | `0.110598286791 0 0.173300593751` | `-π/2 0 -π/2` | `1 0 0` |
...
[ +0.000000  -1.000000  +0.000000  +0.173301 ]
...
| `joint2` | `-1 0 0` | `0 0.090598 0.059801` |
| `joint3` | `1 0 0` | `0 -0.354598 -0.059801` |
| `joint4` | `1 0 0` | `0 -0.109599 0.000199` |
